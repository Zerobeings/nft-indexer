...
const fileData = fs.readFileSync('eth-indexed/twindexed.json');
...
async function fetchAllMetadata() {
    ...
    try {
        const existingData = fs.readFileSync('eth-directory/twdirectory.json');
    ...
    fs.writeFileSync('eth-directory/twdirectory.json', JSON.stringify(allMetadata, null, 2));
}
