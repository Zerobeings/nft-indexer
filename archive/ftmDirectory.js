...
const fileData = fs.readFileSync('ftm-indexed/indexed.json');
...
async function fetchAllMetadata() {
    ...
    try {
        const existingData = fs.readFileSync('ftm-indexed/indexed.json');
    ...
    fs.writeFileSync('ftm-indexed/indexed.json', JSON.stringify(allMetadata, null, 2));
}
